...
export default function Welcome({ onStart }: WelcomeProps) {
  return (
    <div className="flex-1 flex flex-col items-center justify-center text-center px-6 py-6 md:px-8 md:py-8 max-w-4xl mx-auto">
      <motion.div 
        initial={{ opacity: 0, y: 30 }}
        animate={{ opacity: 1, y: 0 }}
        className="w-full"
      >
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-xero-blue/10 rounded-full text-xero-blue text-[10px] font-bold tracking-[0.2em] uppercase mb-5 md:mb-6 border border-xero-blue/20">
          <div className="w-2 h-2 bg-xero-blue rounded-full animate-pulse" />
          London 2026
        </div>
        
        <h2 className="text-5xl md:text-7xl xl:text-9xl font-black text-xero-navy tracking-tighter leading-[0.88] md:leading-[0.85] mb-5 md:mb-6">
          Meet Your<br />
          <span className="text-xero-blue italic font-serif lowercase tracking-normal">Best</span>
          <br />Self.
        </h2>
        
        <div className="text-lg md:text-xl xl:text-2xl font-medium text-xero-navy/70 tracking-tight mb-8 md:mb-10 max-w-3xl mx-auto leading-relaxed space-y-3">
